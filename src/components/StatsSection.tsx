...
const stats = [
  { value: 250, suffix: "+", label: "Businesses Automated" },
  { value: 400, suffix: "+", label: "Funnels & Workflows Built" },
  { value: 7500, suffix: "+", label: "Hours Saved for Clients" },
  { value: 20, suffix: "+ Years", label: "Sales & Automation Experience" },
];
